...
mv "$temp_dir/$executable" "$install_dir" || display_error "Failed to move $executable to $install_dir."

# Grant executable permissions
chmod +x "$install_dir/$executable" || display_error "Failed to grant executable permissions to $install_dir/$executable."
